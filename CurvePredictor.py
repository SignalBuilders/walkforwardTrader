        ...
        with mpEngine.Manager() as manager:
            ...
            for clippedIdentifiers in identifierWindows:
                ...
                if earlyStop == True:
                    ...
                    elif (((empyrical.sharpe_ratio(returnStream) < 0.25 and sharpeDiff < 0.0) and shortSeen == 1) or ((empyrical.sharpe_ratio(returnStream) < 0.45 and sharpeDiff < 0.0) and (shortSeen == 2 or shortSeen == 3)) or abs(rawBeta) > 0.6 or activity < 0.3) and (shortSeen == 1 or shortSeen == 2 or shortSeen == 3):
